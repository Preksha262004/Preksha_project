      ...
      <div class="row justify-content-center fullscreen align-items-center">
        <div class="col-lg-5 col-md-8 home-banner-left">
          ...
          <p class="mx-auto text-white  mt-20 mb-40">
            Unlock the door to knowledge. Redefine learning with innovative tools, expert instructors, dedicated book dealers, and boundless opportunities education reimagined for every student.
          </p>
        </div>
        ...
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            ...
            <div class="ml-20">
              <h4>New Classes</h4>
              <p>
                You are starting something new or leveling up your expertise skills, our latest classes are here to guide you on your e - learning journey.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex">
            ...
            <div class="ml-20">
              <h4>Top Courses</h4>
              <p>
                These courses are highly recommended by students and experts for their comprehensive content, guidance and practical applications.
              </p>
            </div>
          </div>
        </div>
        <div class="col-lg-2 col-md-6">
          <div class="feature-item d-flex border-right-0">
            ...
            <div class="ml-20">
              <h4>Full E-Books</h4>
              <p>
                Start exploring today and unlock endless opportunities for knowledge.Download, read and learn anytime, anywhere with easy access to e-books.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container-fluid">
      <div class="row justify-content-center section-title">
        <div class="col-lg-12">
          ...
          <p>
            Explore trending courses designed to boost your skills and knowledge - learn what’s popular right now!
          </p>
        </div>
      </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="offset-lg-1 col-md-6 video-left">
          <!-- <div class=" owl-carousel video-carousel"> -->
            ...
            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="img/rb.jpg" alt="">
                <div class="overlay"></div>
          ...
          <div class="single-blog-post">
            ...
            <div class="text">
              ...
              <div>
               ...
               <a href="books/ai1.pdf" download="Book_Name.pdf" 
                style="display: inline-block; padding: 10px 15px; font-size: 16px; font-weight: bold; color: #fff; background-color: #76a6d8; border: none; border-radius: 8px; text-decoration: none; cursor: pointer; transition: background 0.3s, transform 0.2s;">
                 Download PDF
               </a>
              <!-- <a href="#" class="primary-btn">
          ...
          <div class="single-blog-post">
            ...
            <div class="text">
              ...
              <div>
               ...
               <a href="books/NOSQL1.pdf" download="Book_Name.pdf" 
                style="display: inline-block; padding: 10px 15px; font-size: 16px; font-weight: bold; color: #fff; background-color: #76a6d8; border: none; border-radius: 8px; text-decoration: none; cursor: pointer; transition: background 0.3s, transform 0.2s;">
                 Download PDF
               </a>
              <!-- <a href="#" class="primary-btn">
