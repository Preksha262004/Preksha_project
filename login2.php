...
<head>
    ...
    <style>
        ...
        .form-container {
            ...
            padding: 20px;
            border-radius: 8px;
            width: 250px; /* Reduced the width of the form */
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            text-align: center;
        }
        .form-container h3 {
            color: #01579b;
            margin-bottom: 15px; /* Reduced margin to fit */
        }
        .form-container label {
            display: block;
            margin: 5px 0 3px; /* Reduced margin for compactness */
            color: #0277bd;
            text-align: left;
            font-size: 14px; /* Reduced font size for smaller form */
        }
        ...
        .form-container p {
            margin: 10px 0;
            font-size: 13px; /* Reduced font size for links */
        }
        .form-container a {
            color: #0288d1;
