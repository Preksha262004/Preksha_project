...
<body>
  <div class="form-container">
    <h3>Login</h3>
    <form action="homeinstructor.php" method="POST">
    ...
    <p>Don't have an account?
      <a href="signup_instrustor.php">Sign Up</a>
    </p>
    <p>
...
if (isset($_POST['submit'])) {
  ...
  $stmt = $conn->prepare("INSERT INTO instructor (firstname, lastname, email, phone, password, register_date, dob, acno) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
